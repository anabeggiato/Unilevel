...
class Scene01 extends Phaser.Scene{
    constructor(){
     ...
     //imagens
    preload(){
        this.load.image('bg', 'assets/c1_bg.png');
        this.load.spritesheet('player', 'assets/ursofofo.png', { frameWidth: 383, frameHeight: 255 });
        this.load.image('exclamacao','assets/c1_exclamaçao.png');
        this.load.image('chao','assets/c1_chao.jpeg');
        this.load.image('balaoimagem', 'assets/balão_escrita.png')
    };
    ...
    create(){   
       ...
       teclado = this.input.keyboard.createCursorKeys();
        ...
        this.physics.add.overlap(player, exclamacao, () =>{
            ...
            //this.scene.switch('Scene02')
        }
        );
        //adiciona o chão onde o player vai andar
        chao = this.physics.add.staticImage(450, 575, 'chao');
